...
type ApiProduct = { id: string; name: string; sku: string | null; category: string | null; sellingPrice: string | number; costPrice: string | number; stockQuantity: number; lowStockLevel: number };
...
export default function ProductsPage() {
  ...
  const filtered = useMemo(
    () => products.filter((p) => `${p.name} ${p.sku} ${p.category}`.toLowerCase().includes(query.toLowerCase())),
    [products, query],
  );
